    ...
    <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
        <div class="d-flex justify-content-center">
            <div class="text-center">
                ...
                <a class="btn btn-primary" href="https://www.arquetiposanonimos.com.br/" target="_blank">Site oficial</a>
...
<!-- Sobre -->
<section class="about-section text-center w-100 d-grid justify-content-center align-items-center" id="about" style="justify-items: center;">
